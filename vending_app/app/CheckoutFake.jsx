...
//       <Button
//         size="icon"
//         onPress={(e) => setQuantity((prev) => (prev > 1 ? --prev : prev))}
//       >
//         <Minus className={quantity > 1 ? "" : "opacity-40"} />
//       </Button>
//     </View>
//   );
// };
    ...
    <TableRow>
      ...
      <TableCell className="h-12 flex items-center justify-center">
        <Text className="absolute">
          {t("totalPrice")} {totalPrice.toFixed(2)} {t("sar")}
        </Text>
      </TableCell>
      <TableCell />
    </TableRow>
                ...
                return (
                  <TableRow key={_id}>
                    ...
                    <TableCell className="flex items-center justify-center">
                      <Text>
                        {" "}
                        {(campaignPrice ?? salePrice)?.toFixed(2)} {t("sar")}
                      </Text>
                    </TableCell>
                    <TableCell className="flex items-center justify-center">
                      <Text>{amount}</Text>
                    ...
                    <TableCell className="flex items-center justify-center">
                      <Text>
                        {((campaignPrice ?? salePrice) * (total[_id] ?? amount)).toFixed(2)}
                        {` ${t("sar")}`}
                      </Text>
                    </TableCell>
                    <TableCell className="flex items-center justify-center">
...
const Checkout = () => {
  ...
  const pay = async () => {
    ...
    //   new MFInvoiceItem("test", 1, 2),
    //   new MFInvoiceItem("test 2", 2, 3),
    //   new MFInvoiceItem("test 3", 2, 1),
    // ];
    ...
    // executePaymentRequest.CustomerAddress = new MFCustomerAddress(
    //   "test",
    //   "test",
    //   "test",
    //   "test",
    ...
    //   new MFSupplier(1, 5, 5),
    //   new MFSupplier(2, 5, 5),
    // ];
  ...
  return (
    <>
      ...
      <View className="flex items-center mx-4">
        <Image
          source={{ uri: `https://server.moaddi-app.com/content/fake.png` }}
          // width=""
          height="100"
          resizeMode="contain"
      ...
      <View className="flex items-center flex-row mx-4">
        <TextInput
          className="flex-1 rounded-lg bg-muted text-foreground px-4 py-3 text-sm border border-gray-200"
